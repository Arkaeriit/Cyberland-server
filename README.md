...
Then, the posts have a `time` fields. This field should either contain the time-stamp of the post in UNIX seconds or 0 if this is not applicable or not computed.
